...
const App = () => {
    ...
    useEffect(() => {
        try {
            ...
            setError("Failed to initialize Firebase. Check your configuration keys.");
            setLoading(false);
        }
    }, []);
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(scheduleCollectionRef, (snapshot) => {
            ...
            setError("Failed to load schedule data. Check Firestore rules and configuration.");
            setLoading(false);
        });
...
// --- Day Card Component ---
const DayCard = ({ day, currentUserId, onSignup, onRemove, db, appId }) => {
